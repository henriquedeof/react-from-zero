            ...
            <div>
                <form onSubmit={this.addItem}>
                    <input type="text" placeholder="Nova Tarefa?" name="tarefa"
                           ...
                           {/*Field this._tarefaInput is created to be used on addItem() funcion. It is created to the REF attribute.
                             In this case, this._tarefaInput is a reference on my tarefa input.
                             */}
                    <button type="submit">
                        Adicionar
                    </button>       
